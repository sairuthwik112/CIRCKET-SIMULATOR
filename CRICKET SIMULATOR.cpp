...
void welcome_message()
{
    ...
    cout<<"\n2. You have to choose the number of overs you want to play the game. The number of overs should not be more than 10 overs!";
    ...
    cout<<"\n5. Team 1 will be batting first and Team 2 will be bowling first";
...
void input_overs()
{
    cout<<"\nEnter the number of overs you want to play the game : ";
    cin>>number_of_overs;
...
void player_names_input()
{
    ...
    else
    {
        ...
        strcpy(team[0].player_name[1]," Faf ");
        strcpy(team[0].player_name[2],"Maxi");
        strcpy(team[0].player_name[3],"Rawat");
        strcpy(team[0].player_name[4],"Lomror");
        strcpy(team[0].player_name[5],"Karthik");
        strcpy(team[0].player_name[6],"Siraj");
        strcpy(team[0].player_name[7],"Hazlewood");
        strcpy(team[0].player_name[8],"Harshal");
        strcpy(team[0].player_name[9],"Vijay");
        strcpy(team[0].player_name[10],"Hasaranga");

        strcpy(team[1].player_name[0],"Rohit");
        strcpy(team[1].player_name[1],"Ishan");
        strcpy(team[1].player_name[2],"Wadhera");
        strcpy(team[1].player_name[3],"Green");
        strcpy(team[1].player_name[4],"David");
        strcpy(team[1].player_name[5],"Suryakumar");
        strcpy(team[1].player_name[6],"Jordan");
        strcpy(team[1].player_name[7],"Chawla");
        strcpy(team[1].player_name[8],"Jason");
        strcpy(team[1].player_name[9],"Madhwal");
        strcpy(team[1].player_name[10],"Kartikeya");
    }
}
